(function () {
  ...
  function writeState(state) {
    localStorage.setItem(roleStorageKey, JSON.stringify({ roles: state.roles.map(normalizeRole) }));
  ...
  function recordAuditLog(entry = {}) {
    ...
    localStorage.setItem(auditStorageKey, JSON.stringify({ logs: nextLogs }));
